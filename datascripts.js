...
function convertCellToArray(t){return[letterToColumn(t.replace(/[0-9]*$/g,"")),parseInt(t.replace(/^[A-Z]*/g,""))]}function convertArrayToCell(t){return columnToLetter(t[0])+t[1]}sortAlphaNum=function(t,e){return t.localeCompare(e,"en",{numeric:!0})},cellToColumn=function(t){return t.toUpperCase().match(/^[A-Z]+/g)[0]},cellToRow=function(t){return t.toUpperCase().match(/[0-9]+$/g)[0]},columnToLetter=function(t){for(var e,r="";t>0;)e=(t-1)%26,r=String.fromCharCode(e+65)+r,t=(t-e-1)/26;return r},letterToColumn=function(t){for(var e=0,r=t.length,n=0;n<r;n++)e+=(t.charCodeAt(n)-64)*Math.pow(26,r-n-1);return parseInt(e)},subtractCells=function(t,e){if("string"==typeof t)var r=convertCellToArray(t);else r=t;if("string"==typeof e)var n=convertCellToArray(e);else n=e;return r.map(function(t,e){return t-parseInt(n[e])})},addCells=function(t,e){if("string"==typeof t)var r=convertCellToArray(t);else r=t;if("string"==typeof e)var n=convertCellToArray(e);else n=e;return r.map(function(t,e){return t+parseInt(n[e])})},addA1Notation=function(t,e){if(t.match(/!/g)){var r=t.split("!")[0]+"!";t=t.split("!")[1]}else r="";return sA1NotationOffset=convertArrayToCell(addCells(t,e)),r+sA1NotationOffset},subtractA1Notation=function(t,e){if(t.match(/!/g)){var r=t.split("!")[0]+"!";t=t.split("!")[1]}else r="";return sA1NotationOffset=convertArrayToCell(subtractCells(t,e)),r+sA1NotationOffset},getGoogleSheetRange=function(t){return aReturn=[],t.replace(/;/,",").split(",").forEach(function(t){if(t.indexOf(":")>-1){var e=convertCellToArray(t.toString().split(":")[0]),r=convertCellToArray(t.toString().split(":")[1]);aReturn=aReturn.concat(combineArraysRecursivelyCartesian([getRange3(e[0],r[0]),getRange3(e[1],r[1])]).map(function(t){return convertArrayToCell(t)}))}else aReturn.push(t)}),aReturn},getGoogleSheetRangeValuesOriented=function(t){return aArray=getGoogleSheetRange(t).filter(function(t){return t.match(/[A-Z]+[0-9]+/)}).reduce(function(t,e,r){return 0==r?(t[0].push(e),t):(bCompletedMatrixingTask=!1,t.forEach(function(r,n){r[0].match(/[0-9]+/)[0]==e.match(/[0-9]+/)[0]&&(t[n].push(e),bCompletedMatrixingTask=!0)}),bCompletedMatrixingTask||t.push([e]),t)},[[]]),aArray};
